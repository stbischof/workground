...
import org.eclipse.daanse.olap.rolap.dbmapper.model.record.AutoGeneratedDateTableR;
...
import org.eclipse.daanse.olap.rolap.dbmapper.model.record.ColumnDefsR;
...
import org.eclipse.daanse.olap.rolap.dbmapper.model.record.HintsR;
...
import org.eclipse.daanse.olap.rolap.dbmapper.model.record.KeyR;
...
public class RDbMappingSchemaModifier extends AbstractDbMappingSchemaModifier {
	...
	protected MappingSchema new_Schema(String name, String description, String measuresCaption, String defaultRole,
		...
		MappingSchema mappingSchemaNew = new SchemaR(name, description,annotations, measuresCaption, defaultRole,
				parameters, dimensions, cubes, virtualCubes, namedSets, roles, userDefinedFunctions, physicalSchema);
    ...
    protected MappingColumnDef new_ColumnDef(
        ...
        return new ColumnDefR(timeDomain, name, type, internalType);
    }
    ...
    @Override
    protected MappingPhysicalSchemaElement new_AutoGeneratedDateTable(
        List<MappingTableElement> tableElements,
        Instant startDate,
        Instant endDate,
        String name,
        String schema,
        ...
        return new AutoGeneratedDateTableR( tableElements,
            startDate,
            endDate,
            name,
            schema,
    ...
    @Override
    protected MappingTableElement new_ColumnDefs(List<RealOrCalcColumnDef> columns) {
        return new ColumnDefsR(columns);
    }

    @Override
    protected MappingTableElement new_Hints(List<MappingHint> hs) {
        return new HintsR(hs);
    }

    @Override
    protected MappingTableElement new_Key(
        List<MappingColumn> columns,
        String name
    ) {
        return new KeyR(columns, name);
    }

    @Override
    protected MappingColumn new_Column(String table, String name, String genericExpression) {
        return new ColumnR(table, name, genericExpression);
    }

    @Override
    protected MappingPhysicalSchema new_MappingSchema(List<MappingPhysicalSchemaElement> childrens) {
        return null;
    }

    @Override
    protected RealOrCalcColumnDef new_CalculatedColumnDef(
