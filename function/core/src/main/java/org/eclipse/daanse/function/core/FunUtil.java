...
//remove after refactoring
   ...
   *              to construct a {@link mondrian.olap.fun.FunDefBase}.
...
//  }
  ...
  public static FunctionDefinition createDummyFunDef(
    FunctionResolver resolver,
    int returnCategory,
    Exp[] args ) {
    final int[] argCategories = ExpBase.getTypes( args );
    return new AbstractFunctionDefinition( resolver, returnCategory, argCategories ) {
    };
  }
